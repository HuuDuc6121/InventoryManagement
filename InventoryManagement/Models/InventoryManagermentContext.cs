...
{
    public partial class InventoryManagermentContext : DbContext
    {
        public InventoryManagermentContext()
        {
        }

        public InventoryManagermentContext(DbContextOptions<InventoryManagermentContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Kho>(entity =>
            {
                ...
                entity.HasOne(d => d.MsLoaiHangNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Kho_Loai Hang");
            });
